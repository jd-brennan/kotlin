...
//    derived.setDelegate(base) // argument type mismatch, this deserves a diagnostic test
    ...
    assertFalse(delegate16_Bar is BarProtocol)  // actual type is Base, which isn't BarProtocol
    ...
    assertFalse(delegate14_Foo is FooProtocol) // actual type is Base, which isn't FooProtocol
    ...
    assertFalse(delegate18_Foo is FooProtocol) // actual type is Base, which isn't FooProtocol
    ...
    assertFalse(delegate15_Bar is BarProtocol) // actual type is Base, which isn't BarProtocol
    ...
    assertFalse(delegate19_Bar is BarProtocol) // actual type is Base, which isn't BarProtocol
...
//    derived.setDelegate(base) //  argument type mismatch: actual type is 'library.Base', but 'library.DerivedWithPropertyOverride?' was expected, this deserves a diagnostic test
    ...
    assertTrue(delegate19_Bar is Base)
    assertFalse(delegate19_Bar is FooProtocol)
    assertFalse(delegate19_Bar is BarProtocol) // actual type is Base, which isn't FooProtocol
