...
fun serializeModuleIntoKlib(
    ...
    // Generated by plugins files
    val filesWithoutSources = serializedIr.files.drop(files.size)
        .map { KotlinFileSerializedData(byteArrayOf(), it) }

    val compiledKotlinFiles = cleanFiles + additionalFiles + filesWithoutSources
