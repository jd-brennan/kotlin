...
open class AnalysisApiFirSourceTestConfiguratorWithLibraryCompilation(
    analyseInDependentSession: Boolean
) : AnalysisApiFirSourceTestConfigurator(analyseInDependentSession) {
    ...
    override val serviceRegistrars: List<AnalysisApiTestServiceRegistrar> =
        super.serviceRegistrars + AnalysisApiLibraryBaseTestServiceRegistrar
}
